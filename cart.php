...
<div class="col-lg-12">	
    ...
    <div class="col-md-4">
    	<div class="card mb-4">
    		<div class="card-header bg-primary text-white"><b>total des frais</b></div>
    		<div class="card-body">
		...
		<p> *En espece </P>
    	<button class="btn btn-block btn-primary" id="checkout" type="button">En espece</button>
		<br>
		<div>
		<p> *En ligne </P>
		<button class="btn btn-block btn-primary" id="checkout" type="button">paypal</button>
		<button class="btn btn-block btn-warning" id="checkout" type="button">Bankily</button>
		</div>
    </div>
</div>
</div>
