<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-primary navbar-dark ">
    ...
    <div class="container">
      ...
      <?php endif; ?>
        <li>
          <a class="nav-link text-white"  href="./" role="button"> <large><b>Boutigoukoum</b></large></a>
        </li>
      </ul>
          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width:25vw">
                ...
                <div class="d-flex bg-light justify-content-center w-100 p-2">
                    <a href="index.php?page=cart" class="btn btn-sm btn-primary btn-block col-sm-4 text-white"><i class="fa fa-edit"></i> Voir Cart</a>
                </div>
              </div>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.5em;">
              <a class="dropdown-item" href="signup.php" id="manage_my_account"><i class="fa fa-cog"></i>Gestion_Compte</a>
              <a class="dropdown-item" href="admin/ajax.php?action=logout2"><i class="fa fa-power-off"></i>Deconnecter</a>
            </div>
          </li>
        <?php endif; ?>
      </ul>
